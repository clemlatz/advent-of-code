...
describe("Day 04", () => {
  ...
  test("returns correct answer for part 1 test input (column)", () => {
    // given
    const inputForColumn = `13,7,2,4,9,5,10,11,12,17,23,2,0,14,21,24,10
...
22 11 13  6  5
 2  0 12  3  7`;
    ...
    // when
    const result = part1(inputForColumn);

    // then
    expect(result).toBe(2724);
  });
